...
public class TtOfInstructorDB extends DBcontext<Lecture> {
    ...
    public List<Lecture> getLecture(String instructor_id, Date from, Date to) {
        ...
        String sql = "SELECT l.subject_id,subject_name,lecture_id,sesion_name,room_id,l.slot_id,date,gr.group_id,sl.starttime,sl.endtime\n"
                + "FROM Lecture l\n"
        ...
        try {
            ...
            while (rs.next()) {
                ...
                l.setSesion_name(rs.getString("session_name")); // Sửa thành session_name
